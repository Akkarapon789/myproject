...
// ⭐️ สำคัญ: ต้องไม่มีช่องว่าง, บรรทัดว่าง, หรือข้อความใดๆ ก่อนบรรทัดนี้
...
if ($conn->connect_error) {
  ...
  // (จะเห็นข้อผิดพลาดนี้เฉพาะตอน Debug ไม่แสดงในหน้า AJAX)
  die("Connection failed: " . $conn->connect_error);
}

// ⭐️ สำคัญ: ไม่ต้องมีเครื่องหมายปิด ?> ในไฟล์นี้