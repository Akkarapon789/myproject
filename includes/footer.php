<footer class="footer-main pt-5 pb-4">
    <div class="container text-center text-md-start">
        <div class="row">
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                <h6 class="text-uppercase fw-bold">หมวดหมู่</h6>
                <hr class="mb-4 mt-0 d-inline-block mx-auto" style="width: 60px; background-color: var(--accent-color); height: 2px"/>
                <p><a href="#!" class="text-reset">นิยาย</a></p>
                <p><a href="#!" class="text-reset">พัฒนาตัวเอง</a></p>
                <p><a href="#!" class="text-reset">ธุรกิจ</a></p>
            </div>
            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                <h6 class="text-uppercase fw-bold">ช่วยเหลือ</h6>
                <hr class="mb-4 mt-0 d-inline-block mx-auto" style="width: 60px; background-color: var(--accent-color); height: 2px"/>
                <p><a href="#!" class="text-reset">วิธีการสั่งซื้อ</a></p>
                <p><a href="#!" class="text-reset">คำถามที่พบบ่อย</a></p>
                <p><a href="#!" class="text-reset">ติดต่อเรา</a></p>
            </div>
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                <h6 class="text-uppercase fw-bold">ติดตามเรา</h6>
                <hr class="mb-4 mt-0 d-inline-block mx-auto" style="width: 60px; background-color: var(--accent-color); height: 2px"/>
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        © <?= date("Y") ?> Copyright: <a class="text-white" href="index.php">TheBookmarkSociety.com</a>
    </div>
</footer>