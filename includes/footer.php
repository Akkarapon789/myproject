  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-5 text-center"><img id="quickViewImage" src="" class="img-fluid rounded" style="aspect-ratio: 3/4; object-fit: cover;"></div>
          <div class="col-md-7">
            <h2 id="quickViewTitle" class="fw-bold"></h2>
            <p id="quickViewCategory" class="text-muted"></p>
            <p id="quickViewDesc" class="lead"></p>
            <div class="my-4"><span id="quickViewPrice" class="product-price-new fs-2"></span></div>
...
$(document).ready(function(){
    ...
    $(document).on('click', '.js-quick-view', function(e) {
        e.preventDefault(); // ⭐️ คำสั่งสำคัญ: หยุดการ Redirect ⭐️
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    quickViewModal.show();
                } else { alert('ไม่พบข้อมูลสินค้า'); }
            },
            error: function() { alert('เกิดข้อผิดพลาดในการดึงข้อมูล'); }
        });
    });
});
</script>
